...
export default function NewEntry(){
    ...
    return(
        <section className={colourTheme['list-item-background'] + " flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 p-8 rounded-md"}>
            ...
            <button onClick={(e) => {handleSend(e)}} className={"text-white bg-blue-400 hover:bg-blue-600 font-semibold p-3 rounded-md"}>Create</button>
        </section>
    )
}